...
export function newSongPick(t, det){
  ...
  return { kind:'song', deezerId:t.id, tmdbId:null, label:t.label, preview:t.preview||'', cover:t.cover||t.thumb||'',
           clues, prompt:'Welk nummer is dit?', answerSearch:true };   // grote hoes opslaan, zodat een opnieuw geladen vraag 'm óók groot toont
}
...
export function newPuzzlePick(rd, key, it, details){
  ...
  return { kind:'puzzle', tmdbId:details?details.id:null, tmdbMedia:details?details.media:null, deezerId:null,
           ...
           accept:(it.accept||[]).slice(), clues, prompt:(rd&&rd.heading)||'Wie of wat is dit?', answerSearch:false };
}
...
/* ============================================================
   ...
   ============================================================ */
export function newCustomPick(){ return { kind:'custom', prompt:'', clues:[], answerMode:'open', correct:[''], distractors:[''], poolId:'' }; }
