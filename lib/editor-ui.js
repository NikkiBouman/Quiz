...
export function openQuestionPreview(question, root){
  ...
  ov.innerHTML = `<div class="pv-modal">
      <div class="pv-bar"><b>Voorbeeld van deze vraag</b>
        ...
        <button class="btn ghost sm" id="pv-close">Sluiten ✕</button></div>
      <div class="pv-panes">
        <div class="pv-pane host"><div class="pv-label">🖥️ Host-scherm</div>
          <iframe class="pv-frame" src="${esc(base)}index.html?preview=host" title="Host-voorbeeld"></iframe></div>
        <div class="pv-pane player"><div class="pv-label">📱 Speler-scherm</div>
